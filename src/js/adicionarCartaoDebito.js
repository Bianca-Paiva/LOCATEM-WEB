...
function atualizarResumoDebito() {
...
function carregarCartaoSalvo() {
    ...
    const cartao = localStorage.getItem('cartaoDebito');
    if (!cartao) return;
...
function salvarCartao() {
    ...
    const tipo = localStorage.getItem('tipoNovoCartao') || 'debito'; // 'credito' ou 'debito'
...
function removerCartaoSalvo() {
    localStorage.removeItem('cartaoDebito');
}
